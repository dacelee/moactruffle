...
From there, you can run `moactruffle compile`, `moactruffle migrate` and `moactruffle test` to compile your contracts, deploy those contracts to the network, and run their associated unit tests.
